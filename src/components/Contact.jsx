      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="bg-dark-300 p-8 rounded-3xl border border-white/5 shadow-2xl relative"
          >
            ...
            <form className="space-y-6 relative z-10">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    id="name"
                    className="w-full bg-dark-400/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-500/50 focus:bg-dark-400 transition-all duration-300"
                    type="text"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  id="message"
                  className="w-full h-40 bg-dark-400/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-sky-500/50 focus:bg-dark-400 transition-all duration-300 resize-none"
          ...
          >
            ...
            <div className="pt-8 border-t border-white/10">
              ...
              <div className="flex gap-4">
                {[
                  { Icon: FaGithub, href: "https://github.com/zenithshah07-creator", color: "hover:bg-gray-800" },
                  ...
                  <a
                    ...
                    className={`w-12 h-12 bg-dark-300 rounded-full flex items-center justify-center text-gray-400 hover:text-white ${social.color} transition-all duration-300 shadow-lg`}
                  >
                    <social.Icon size={20} />
                  </a>
                ))}
